...
The intercept tells us that for a car in 1999 with no engine displacement, the highway fuel efficiency for the  car is 35.7922 miles per gallon. 

3. What does the coefficient on `displ` tell you, in words? 

The coefficient on `displ` tells us that with one a one liter increase in engine displacement for a 1999 car, there will be a 3.7684 loss in highway fuel efficiency. 

4. What does the coefficient estimate on the 2008 vintage indicator variable (`year2008`) tell you, in words? 

For a 2008 car with a 0 liter engine, there will be a 0.3455 increase in highway fuel efficiency in mpg. 
...
In a car in 2008 with a one liter increase in engine displacement, the highway fuel efficiency will become 35.7922 + (-3.7684) + 03445 + 0.3052. It is the difference in the slope. (this probably wrong)
