...
The intercept tells us that for no engine displacement, and without the impact of the year, the highway fuel efficiency for a car is 35.7922. 

3. What does the coefficient on `displ` tell you, in words? 

The coefficient on `displ` tells us that with one a one unit increase in engine displacement, not including the impact of year or the combined impact of year and displacement, there will be a 3.7684 loss in highway fuel efficiency. 
